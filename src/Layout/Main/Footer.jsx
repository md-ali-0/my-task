...
const Footer = () => {
    ...
    return (
        <footer className="bg-black/90 px-3">
            <div className="mx-auto w-full max-w-screen-xl py-6 lg:py-8">
                <div className="flex flex-col md:flex-row justify-between px-5 lg:px-0">
                    <div className="mb-6 md:mb-0 md:w-1/3">
                        ...
                        <p className="py-2 text-gray-300">
                            Transform your productivity with My Task, the
                            ultimate task management solution. Streamline your
                            workflow, collaborate seamlessly, and stay organized
                            effortlessly.
                        </p>
                    </div>
                ...
                <div className="flex items-center justify-center flex-col">
                    <div className="flex mt-4 sm:justify-center sm:mt-0 pb-3">
                        <Link className="text-gray-500 hover:text-gray-900  ms-5 bg-gray-300 rounded-full shadow p-2">
